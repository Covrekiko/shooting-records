      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-start justify-between mb-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity flex items-center gap-2 text-sm whitespace-nowrap mt-2"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div>
                 ...
                 <div>
                   <label className="block text-xs font-medium mb-1">Deer Species</label>
                   <select
                 ...
                 <div>
                   <label className="block text-xs font-medium mb-1">Number Shot</label>
                   <input
                     type="number"
                 ...
                 <div>
                   <label className="block text-xs font-medium mb-1">Rifle Used</label>
                   <select
                 ...
                 <div>
                   <label className="block text-xs font-medium mb-1">Ammunition Used</label>
                   <input
                     type="text"
