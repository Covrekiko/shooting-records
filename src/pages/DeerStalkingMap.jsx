...
export default function DeerStalkingMap() {
  ...
  return (
    <div className={`w-full h-screen bg-slate-900 relative overflow-hidden ${waitingForPin ? 'cursor-crosshair' : ''}`}>
      ...
      {waitingForPin && (
        <div className="fixed top-4 left-4 z-[9998] bg-blue-500 text-white px-2 py-0.5 rounded flex items-center justify-between pointer-events-auto gap-1 h-6 w-20">
