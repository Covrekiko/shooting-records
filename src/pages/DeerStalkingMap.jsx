...
export default function DeerStalkingMap() {
  ...
  const getPOIDetails = (marker) => [
    ...
    marker.marker_type === 'deer_sighting' && marker.species && ['Species', marker.species],
    marker.marker_type === 'deer_sighting' && marker.sex && ['Sex', marker.sex],
    marker.marker_type === 'deer_sighting' && marker.age_class && ['Age class', marker.age_class],
    marker.marker_type === 'deer_sighting' && marker.quantity && ['Quantity', marker.quantity],
    marker.marker_type === 'tracks_signs' && marker.sign_type && ['Sign type', marker.sign_type],
    marker.marker_type === 'animal' && marker.animal_category && ['Animal category', marker.animal_category],
