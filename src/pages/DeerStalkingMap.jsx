  ...
  return (
    <div className="w-full h-screen bg-slate-900 relative overflow-hidden cursor-crosshair">
      ...
      <div className="fixed top-4 right-4 z-[9999] flex flex-col gap-2 pointer-events-auto items-end">
       ...
       <Link
         to="/"
         className="fixed bottom-24 right-6 z-[9997] flex items-center gap-2 px-4 py-2 bg-slate-800 text-white rounded-lg hover:bg-slate-700 transition-all pointer-events-auto sm:bottom-32"
       >
