...
export default function Dashboard() {
  ...
  return (
     <div className="bg-gradient-to-b from-background via-background to-secondary/5">
       ...
       <main className="max-w-7xl mx-auto px-4 pt-2 md:pt-12 pb-20">
         ...
         {user?.role === 'admin' ? (
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 md:mt-4">
            <StatCard
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 md:mt-4">
           <StatCard
             icon={<Map className="w-8 h-8" />}
             label="Stalking Map"
             link="/deer-stalking"
