...
export const DESIGN = {
  ...
  CARD_ACTIVE: 'bg-primary-soft border border-primary-soft-border rounded-2xl shadow-sm',
  ...
  // Buttons
  BUTTON_PRIMARY: 'px-5 py-2.5 bg-primary text-primary-foreground rounded-xl font-semibold text-sm hover:bg-primary-hover active:scale-[0.97] transition-all duration-100 shadow-sm',
