  ...
  return (
    <div className={isGrouped ? "relative" : "fixed bottom-24 right-6 z-[9999] pointer-events-auto sm:bottom-32"}>
      ...
      {!isOpen ? (
        ...
        /* Expanded Search Bar */
        <form onSubmit={handleSearch} className={isGrouped ? "absolute bottom-0 -right-80 w-72 sm:w-80 max-w-[calc(100vw-2rem)] pointer-events-auto" : "absolute bottom-0 right-0 w-72 sm:w-80 max-w-[calc(100vw-2rem)] pointer-events-auto"}>
