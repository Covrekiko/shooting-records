...
export default function LegalShootingHoursWidget() {
  ...
  return (
    ...
    <div className="bg-white/90 backdrop-blur-lg rounded-2xl px-3 py-2 border border-white/40 shadow-md hover:shadow-lg transition-shadow" style={{ WebkitBackdropFilter: 'blur(20px)', isolation: 'isolate' }}>
