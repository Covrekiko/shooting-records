...
export default function MobileScaleCalibrationSheet({
  ...
  return (
    <div className="md:hidden sticky top-0 z-40 -mx-4 px-4 pt-1 pb-3 bg-background pointer-events-none">
      <div className="pointer-events-auto bg-card border border-border shadow-md rounded-2xl p-3" style={{ touchAction: 'manipulation' }}>
