...
export default function MobileScaleCalibrationSheet({
  ...
  return (
    <div data-calibration-controls className="md:hidden absolute inset-x-2 top-2 z-40 pointer-events-none">
      <div className="pointer-events-auto bg-card/95 backdrop-blur-xl border border-border shadow-xl rounded-2xl p-3 max-h-[45vh] overflow-y-auto" style={{ touchAction: 'manipulation' }}>
        ...
        <div className="grid grid-cols-[1fr_92px] gap-2 mb-3">
          <input
            value={scaleInput}
