    ...
    <div className="fixed inset-0 z-[70000] bg-black/70 flex items-end sm:items-center justify-center" onClick={onClose}>
      ...
      >
        ...
        <div className="px-5 py-4 space-y-4 pb-8">
          {/* Group Size Metrics */}
          {(group.group_size_moa > 0 || group.group_size_mm > 0) && (
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {group.group_size_moa > 0 && (
                  <div className="bg-primary/10 rounded-xl p-3 text-center">
                    <p className="text-2xl font-black text-primary">{group.group_size_moa?.toFixed(2)}</p>
                ...
                {group.group_size_mm > 0 && (
                  <div className="bg-secondary rounded-xl p-3 text-center">
                    <p className="text-xl font-bold">{group.group_size_mm}mm</p>
                    <p className="text-xs text-muted-foreground">mm</p>
                  </div>
                )}
                {group.group_size_inches > 0 && (
                  <div className="bg-secondary rounded-xl p-3 text-center">
                    <p className="text-xl font-bold">{group.group_size_inches}"</p>
          ...
          <div className="bg-card border border-border rounded-xl px-4 py-1">
            <Row label="Shots" value={group.number_of_shots > 0 ? group.number_of_shots : null} />
